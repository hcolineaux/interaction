...
- L'effet de la défavorisation est : 
    ...
    + Quand on est une homme : $\small DR(D|S=1) = 0.126 - 0.095 =$ +`r round(0.126 - 0.095,3)` mmol/L
...
L'outcome étant binaire, il est plus classique d'utiliser un modèle logistique, dont les résultats (en odds ratio) seraient : 
