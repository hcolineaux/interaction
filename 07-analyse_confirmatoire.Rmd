...
Il s'agit d'une "G-method" qui peut être décrite comme une "standardisation" par régression (Hernàn @hernan2020causal). Le principe est le suivant :
