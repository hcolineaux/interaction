...
\date{Last compiled on 01 août, 2023}
...
Une propriété intéressantes des RR et des DR est que se sont des mesures d'associations \textbf{collapsibles} (anglicisme venant du terme anglais \emph{collapsibility}) : la mesure conditionnelle est la même que la mesure marginale.@whitcomb2021

En revanche, les odds-ratios (OR) sont des mesures d'associations \textbf{non-collapsibles}, c'est-à-dire qu'un OR conditionnel sera différent d'un OR marginal (en dehors de cas particuliers où l'association est nulle ou bien lorsqu'aucun des facteurs de confusion potentiel n'a d'effet sur l'outcome \(Y\)). Cela est parfois source de confusion car :
