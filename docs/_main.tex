...
\date{Last compiled on 07 June, 2023}
...
\tightlist
\item
  \textbf{Antagonisme parfait} (ligne 10): l'effet joint est nul \(\small p_{11} - p_{00} = 0\), alors que les effets individuels sont positifs.
\item
