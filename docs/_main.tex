...
\date{Last compiled on 04 mai, 2023}
...
\hypertarget{avec-les-odds-ration-or}{%
\section{Avec les Odds Ration (OR)}\label{avec-les-odds-ration-or}}
...
Un paramètre d'interaction sur l'echelle multiplicative (MI\_\{OR\}) peut être estimé à partir de ces OR \citet{vanderweele_tutorial_2014} :
...
En général, la mesure \(MI_{OR}\) et \(MI_{RR}\) seront proches si l'outcome est rare \citet{vanderweele_tutorial_2014}.
...
\hypertarget{part-estimations}{%
\part{Estimations}\label{part-estimations}}
...
Au final, on a comme P(Y==1) dans chaque catégorie :
...
\hypertarget{estimation-par-ruxe9gression}{%
\section{Estimation par régression}\label{estimation-par-ruxe9gression}}

\hypertarget{multiplicatif-ruxe9gression-logistique}{%
\subsection{Multiplicatif (régression logistique)}\label{multiplicatif-ruxe9gression-logistique}}
...
\hypertarget{additif-ruxe9gression-lineaire}{%
\subsection{Additif (régression lineaire)}\label{additif-ruxe9gression-lineaire}}
...
\hline
A1=0 & \$p\_\{00\}\$=0.104 [0.095,0.113] & \$p\_\{01\}\$=0.197 [0.183,0.211] & 0.092 [0.076,0.109] & 1.89 [1.68,2.11]\\
\hline
A1=1 & \$p\_\{10\}\$=0.405 [0.379,0.431] & \$p\_\{11\}\$=0.891 [0.87,0.912] & 0.486 [0.453,0.519] & 2.2 [2.06,2.36]\\
\hline
...
\multicolumn{5}{l}{\rule{0pt}{1em}additive Interaction = 0.394 [0.358;0.43]}\\
\multicolumn{5}{l}{\rule{0pt}{1em}RERI = 3.78 [3.38;4.23]}\\
...
\multicolumn{5}{l}{\rule{0pt}{1em}multiplicative Interaction = 1.11}\\
\end{tabular}
\end{table}
...
##                     RD.A2|A1         RR.A2|A1
## A1=0     0.091 [0.073,0.109] 1.88 [1.67,2.11]
## A1=1     0.496 [0.457,0.535]  2.22 [2.05,2.4]
## RD.A1|A2                                     
## RR.A1|A2                                     
## 
## $interaction.effects
...
## A1=1       $p_{10}$=0.4 [0.373,0.427] $p_{11}$=0.893 [0.872,0.915]
## RD.A1|A2          0.296 [0.267,0.325]          0.697 [0.671,0.722]
## RR.A1|A2             3.86 [3.45,4.32]             4.54 [4.46,4.61]
##                     RD.A2|A1        RR.A2|A1
## A1=0      0.093 [0.076,0.11] 1.9 [1.69,2.13]
## A1=1     0.494 [0.459,0.528] 2.23 [2.08,2.4]
## RD.A1|A2                                    
## RR.A1|A2                                    
## 
## $interaction.effects
## [1] "additive Interaction = 0.4 [0.362;0.439]"     
## [2] "RERI = 3.86 [3.46;4.31]"                      
## [3] "multiplicative Interaction = 1.18 [1.02;1.35]"
\end{verbatim}
...
Les recommandation de Knol et al. \citet{knol_recommendations_2012} sont :

\hypertarget{modification-deffet}{%
\section{Modification d'effet}\label{modification-deffet}}
...
\section{Interaction}\label{interaction-1}}
...
\textbf{2. DAG, estimand, estimateur}

Le DAG (sans les médiateurs) était :

\begin{quote}
\includegraphics[width=0.3\textwidth,height=\textheight]{img/Image13.png}
\end{quote}
...
Les effets ont été estimés par g-computation (\emph{standardisation}).
