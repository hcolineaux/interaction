...
\textbf{L'estimand} était défini par :
...
\CommentTok{\# Coefficients:}
\CommentTok{\#                 Estimate Std. Error t value Pr(\textgreater{}|t|)    }
\CommentTok{\# (Intercept)    1.3270453  0.0068655  193.29   \textless{}2e{-}16 ***}
\CommentTok{\# sexeWomen     {-}0.3362871  0.0094614  {-}35.54   \textless{}2e{-}16 ***}
\CommentTok{\# age           {-}0.0185252  0.0001335 {-}138.78   \textless{}2e{-}16 ***}
\CommentTok{\# sexeWomen:age  0.0044007  0.0001853   23.75   \textless{}2e{-}16 ***\# {-}{-}{-}}
\CommentTok{\# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  \item
    A 40 ans (par exemple) : \(\small DR(S|A=40) = -33,63 + 0,44 \times 40 =\) -16\%
  \end{itemize}
\item
  ...
  \item
    Quand on est une femme : \(\small DR(A|S=1) = -1,85 + 0.44 =\) -1.4 \% par année d'âge
  \end{itemize}
\item
  ...
  \item
    \(\small DR(A,S) = -33,63 -1,85 + 0,44 =\) -35.1 \%
  \end{itemize}
\item
...
\tightlist
\item
  \(\small Y_{S=0,A=30} = 132,7 - 1,85 \times 30 =\) 77.2\%
\item
  \(\small Y_{S=0,A=50} = 132,7 - 1,85 \times 50 =\) 40.2\%
\item
  \(\small Y_{S=1,A=30} = 132,7 -33,63 - 1,85 \times 30 + 0,44 \times 30 =\) 56.8\%
\item
  \(\small Y_{S=1,A=50} = 132,7 -33,63 - 1,85 \times 50 + 0,44 \times 50 =\) 28.6\%
\end{itemize}
...
\CommentTok{\# (Intercept)    3.9524082  0.0382785  103.25   \textless{}2e{-}16 ***}
\CommentTok{\# sexeWomen     {-}1.1787828  0.0528351  {-}22.31   \textless{}2e{-}16 ***}
\CommentTok{\# age           {-}0.0891173  0.0007808 {-}114.14   \textless{}2e{-}16 ***}
\CommentTok{\# sexeWomen:age  0.0120384  0.0011038   10.91   \textless{}2e{-}16 ***}
\CommentTok{\# {-}{-}{-}}
\CommentTok{\# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# (Intercept)   52.0605878 48.3044121 56.1245459}
\CommentTok{\# sexeWomen      0.3076530  0.2773804  0.3412112}
\CommentTok{\# age            0.9147383  0.9133364  0.9161362}
\CommentTok{\# sexeWomen:age  1.0121112  1.0099239  1.0143033}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  \item
    ``A 1 ans'' : \(\small OR(S|A=1) = \times 0.31 + 0,012 = \times\) 0.3
  \item
    A 40 ans (par exemple) : \(\small OR(S|A=40) = exp(-1,179 + 0,012 \times 40) = \times\) 0.5
  \end{itemize}
\item
  L'effet de l'age est :
  ...
  \item
    Quand on est une femme : \(\small OR(A|S=1) = exp(-0,089 + 0,012) = \times\) 0.9 par année d'âge
  \end{itemize}
\item
  L'effet d'être une femme et d'avoir 1 an de plus
  ...
  \item
    \(\small OR(A,S) = exp(-1,179 -0,089 + 0,012) = \times\) 0.3
  \end{itemize}
\item
...
\tightlist
\item
  \(\small Y_{S=0,A=30} = \frac{exp(3,952 - 0,089 \times 30)}{1+exp(3,952 - 0,089 \times 30)} =\) 78.3\%
\item
  \(\small Y_{S=0,A=50} = \frac{exp(3,952 - 0,089 \times 50)}{1+exp(3,952 - 0,089 \times 50)} =\) 37.8\%
\item
  \(\small Y_{S=1,A=30} = \frac{exp(3,952 - 1,179 - 0,089 \times 30 + 0,012 \times 30)}{1+exp(3,952 - 1,179 - 0,089 \times 30 + 0,012 \times 30)} =\) 61.4\%
\item
  \(\small Y_{S=1,A=50} = \frac{exp(3,952 - 1,179 - 0,089 \times 50 + 0,012 \times 50)}{1+exp(3,952 - 1,179 - 0,089 \times 50 + 0,012 \times 50)} =\) 25.4\%
\end{itemize}
